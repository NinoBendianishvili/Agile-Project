...
skip_dates = ["2024-06-11", "2024-06-13", "2024-06-15", "2024-06-25"]

def should_skip_execution(**kwargs):
    execution_date = kwargs.get('execution_date').date()
    return str(execution_date) in skip_dates
with DAG(
    ...
    def fetch_and_send_to_teams(**kwargs):
        if should_skip_execution(**kwargs):
            print("Skipping execution for today.")
            return
